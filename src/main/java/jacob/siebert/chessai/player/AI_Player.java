...
import jacob.siebert.chessai.move.BookSet;
...
//			System.out.println("---------------------------------------------\n");
	...
	private double maxAction(Board state, int currentDepth, double alpha, double beta) {
...
//			}
	...
	private double minAction(Board state, int currentDepth, double alpha, double beta) {
